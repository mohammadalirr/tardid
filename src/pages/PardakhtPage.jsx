    ...
    <>
      <div className="container-p ">
        ...
        <div className="row row-p">
          <div className="box-container-p col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-9 col-10">
          <div style={{ position: "fixed", top: "3em", left: "5em"}}>
          <Link href="/">
            ...
            <div className="internal-box row">
              <div className=" col-p col col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-9 col-10">
